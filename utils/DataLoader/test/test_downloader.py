...
class TestDownloaderFunctions(unittest.TestCase):
    ...
    def test_get_cancer_trials_list(self, mock_get):
        ...
        fake_json_response = {"FullStudiesResponse": {"FullStudies": [fake_study]}}
    ...
    def test_download_study_info_no_local_file(
        self, mock_file, mock_makedirs, mock_exists, mock_session_cls, mock_sleep
    ):
  ...
  <location>Test Location</location>
    ...
    @patch("src.DataLoader.downloader.os.path.exists")
    @patch("src.DataLoader.downloader.os.makedirs")
    def test_download_study_info_with_local_file_update_needed(
        self, mock_makedirs, mock_exists, mock_session_cls, mock_sleep
    ):
  ...
  <location>Test Location</location>
    ...
    @patch(
        "src.DataLoader.downloader.tqdm", lambda x, **kwargs: x
    )  # bypass tqdm for testing
