...
: "${OUTPUT_DIR:=$PROJECT_ROOT/vm-deployment/snapshots}"
...
Environment variables:
  ...
  OUTPUT_DIR      Snapshot output directory (default: vm-deployment/snapshots)
  ES_HOST         Elasticsearch URL (default: http://localhost:9201)
  ES_PASSWORD     Elasticsearch password (default: trialmatchai)

Examples:
  # Default: use local_test data, output to vm-deployment/snapshots
  ./build-snapshot.sh
